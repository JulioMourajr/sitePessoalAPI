...
exports.getAllExperiencias = async (tipo) => {
    ...
    const result = await pool.query(query) // chamada no banco de dados. 
    return result.rows;
}
...
exports.createExperiencia = async (experiencia) => {
    const result = await pool.query(`INSERT INTO experiencias (titulo, tipo, descricao,"anoInicio", "anoFim") VALUES ($1, $2, $3, $4, $5) RETURNING *`, 
...
exports.updateExperiencia = async (id, experiencia) => {
    ...
    SET titulo = $1, tipo = $2, descricao = $3, "anoInicio" = $4, "anoFim" = $5 WHERE id = $6 
    RETURNING *`, 
